...
- **[ibm_db2](https://github.com/fivetran/community_connectors/tree/main/ibm_db2/ibm_db2)** - This example shows how to connect and sync data from IBM Db2 using Connector SDK. It uses the `ibm_db` library to connect to the database and fetch data.
